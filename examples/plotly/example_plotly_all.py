...
# model.import_spectra(point_picker=dn.pick.Area())
# model.spectra_to_1d()
...
e39.import_waveseries(
    dn.read.waveseries.metno.E39(loc="D"), point_picker=dn.pick.Trivial()
)
