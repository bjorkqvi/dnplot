...
def show_or_save_fig(fig_dict: dict, model, obj_str: str, test_mode: bool, save_fig: bool, filename: str, prefix: str = None) -> None:
...
class Matplotlib:
    ...
    def wavegrid(
        ...
        show_or_save_fig(fig_dict, self.data_dict, 'wavegrid', test_mode, save_fig, filename)
    ...
    def topo(
        ...
        fig_dict.get("ax").legend()
        show_or_save_fig(fig_dict, self.data_dict, 'topo', test_mode, save_fig, filename)
    ...
    def grid(
        ...
        show_or_save_fig(fig_dict, self.data_dict, 'grid', test_mode, save_fig, filename)
    ...
    def wind(
        ...
        show_or_save_fig(fig_dict, self.data_dict, 'wind', test_mode, save_fig, filename)
    ...
    def current(
        ...
        show_or_save_fig(fig_dict, self.data_dict, 'current', test_mode, save_fig, filename)
    ...
    def spectra(
        ...
        show_or_save_fig(fig_dict, self.data_dict, 'spectra', test_mode, save_fig, filename)
    ...
    def waveseries(
        ...
        show_or_save_fig(fig_dict, self.data_dict, 'waveseries', test_mode, save_fig, filename)
    ...
    def spectra1d(
        ...
        fig_dict = plotter(fig_dict, self.data_dict)
        show_or_save_fig(fig_dict, self.data_dict, 'spectra1d', test_mode, save_fig, filename)
    ...
    def scatter(
        ...
        show_or_save_fig(fig_dict, self.data_dict, 'waveseries', test_mode, save_fig, filename, prefix='scatter')
